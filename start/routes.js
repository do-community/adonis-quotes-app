...
Route.get('/register','RegisterController.registrationView').as('register.create')
Route.post('/register-store','RegisterController.postRegister').as('register.store').validator('Register')
Route.get('/login','LoginController.loginView').as('login.create')
Route.post('/login-store','LoginController.postLogin').as('login.store')
